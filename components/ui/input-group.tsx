  ...
  return (
    <div
      ...
      className={cn(
        ...
        "has-[>[data-align=inline-start]]:[&>input]:ps-2 rtl:has-[>[data-align=inline-start]]:[&>input]:pr-2",
        "has-[>[data-align=inline-end]]:[&>input]:pe-2 rtl:has-[>[data-align=inline-end]]:[&>input]:pl-2",
...
const inputGroupAddonVariants = cva(
  "text-muted-foreground flex h-auto cursor-text items-center justify-center gap-2 py-1.5 text-sm font-medium select-none [&>svg:not([class*='size-'])]:size-4 [&>kbd]:rounded-[calc(var(--radius)-5px)] group-data-[disabled=true]/input-group:opacity-50 dark:text-muted",
  {
    variants: {
      align: {
        "inline-start":
          "order-first ltr:pl-3 rtl:pr-3 has-[>button]:ms-[-0.45rem] has-[>kbd]:ms-[-0.35rem]",
        "inline-end":
          "order-last ltr:pr-3 rtl:pl-3 has-[>button]:me-[-0.45rem] has-[>kbd]:me-[-0.35rem]",
        "block-start":
