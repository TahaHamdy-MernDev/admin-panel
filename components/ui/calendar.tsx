  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "relative w-full h-full p-0 text-center [&:last-child[data-selected=true]_button]:ltr:rounded-r-md [&:last-child[data-selected=true]_button]:rtl:rounded-l-md  group/day aspect-square select-none",
          props.showWeekNumber
            ? "[&:nth-child(2)[data-selected=true]_button]:ltr:rounded-l-md [&:nth-child(2)[data-selected=true]_button]:rtl:rounded-l-md"
            : "[&:first-child[data-selected=true]_button]:ltr:rounded-l-md [&:first-child[data-selected=true]_button]:rtl:rounded-r-md",
